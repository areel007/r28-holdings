import WhoWeAreHeroImg from "../../assets/images/about-hero.jpg"
...
export const WhoWeAre = () => {
    return <>
        <section className="h-[70vh] 2xl:h-[50vh] w-full hero">
            <img src={WhoWeAreHeroImg} alt="r28 holding" className="w-full h-full object-cover" />
        ...
        <section>
            <div className="w-[90%] max-w-[1248px] mx-auto py-[40px] md:py-[100px] grid grid-cols-1 lg:grid-cols-2 gap-[40px] lg:gap-[100px]">
                <div className="flex flex-col gap-[20px] md:gap-[40px]">
                    <h1 className="text-[22px] md:text-[30px] 2xl:text-[30px] font-[200] text-[#381313] leading-[1.2]">Established in 2007, R28 is a consolidated and diversified private investment holding company with strategic business interests in various sectors of the Nigerian economy.</h1>

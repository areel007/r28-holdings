import StrategicAlliancesImg from "../assets/images/strategic-alliances2.jpg"
...
export const StrategicAlliances = () => {
    ...
    return <>
        <section className="h-[70vh] 2xl:h-[50vh] w-full hero">
            <img src={StrategicAlliancesImg} alt="r28 holding" className="w-full h-full object-cover" />
        ...
        <section>
            <div className="w-[90%] max-w-[1248px] mx-auto py-[40px] md:py-[100px] grid grid-cols-1 lg:grid-cols-2 gap-[20px] md:gap-[40px] lg:gap-[100px]">
                <h1 className="text-[22px] md:text-[30px] 2xl:text-[30px] font-[200] text-[#381313] leading-[1.2]">
                    As local industry experts, R28 possess in-depth knowledge of the local business environment and understand the challenges our customers face in today's rapidly evolving economy
                </h1>
                ...
                <div>
                    <div className="">
                        ...
                        <p className="text-[16px] md:text-[18px] leading-[1.6] font-[200]">Aligned with global best practices and a collaborative mindset, R28 and its affiliates cultivate strategic partnerships with leading global brands across various sectors. These enduring alliances focus on proactively tackling local industry challenges with tailored global solutions. By harnessing our partners' innovative technologies and services, we optimize our offerings for enhanced customer outcomes. <br /><br />

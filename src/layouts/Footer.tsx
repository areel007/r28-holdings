                ...
                <div className="grid grid-cols-1 md:grid-cols-[40%_1fr_1fr] gap-[20px] md:gap-[50px] mb-[30px]">
                    <div>
                        ...
                        <p className="font-[300] text-[14px] leading-[1.6]">
                            Established in 2007, R28 is a consolidated and diversified private investment holding company with strategic business interest in various sectors of the Nigerian economy.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        <p className="font-[300] text-[14px] leading-[1.6]"><b className="font-[700]">T:</b> <span>+234 906 245 7050</span>, <br /> <span className="block ml-[17px]">+234 906 245 7051</span></p>

                        <p className="font-[300] text-[14px] leading-[1.6]"><b className="font-[700]">E:</b> <span>info@r28.ng</span></p>
                    </div>
                </div>

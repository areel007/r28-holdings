import HeroVideo from "../assets/videos/WhatsApp Video 2024-01-10 at 8.38.03 AM.mp4"
import { ArrowDown } from "../components/Arrow.Down"

export const Hero = () => {
    return <section className="h-screen w-full bg-black hero">
        ...
        <div className="absolute top-0 w-full h-full">
            <div className="w-[90%] max-w-[1248px] mx-auto h-full relative z-[2]">
                ...
                <div className="h-full pt-[100px] pb-[20px] lg:pb-[100px] grid grid-cols-1 lg:grid-cols-[16fr_6fr] items-start gap-[30px] lg:gap-0">
                    <div className="h-full flex flex-col justify-end">
                        <p className="text-white pl-0 lg:pl-[10px]">Meet R28 Holdings</p>
                        <h1 className="text-[50px] xsm:text-[60px] lg:text-[80px] 3xl:text-[140px] text-white leading-[1] font-[300]">Investing in Tomorrow's Possibilities Today!</h1>
                    </div>
